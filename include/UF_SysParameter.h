...
typedef enum
{
	...
	UF_SYS_TOUCH_SENSOR_SENSITIVITY = 0xa1, // Added for supporting SFMSlim.
	UF_SYS_LFD_VERSION = 0xa2,				// Added for supporting SFMSlim. (Read only)

	UF_SYS_KERNEL_VERSION = 0xa3, // Added for supporting SFM60x0 and SFMSlim. (Read only)
	UF_SYS_SECURE_PACKET_PROTOCOL = 0xa5,
