...
extern "C"
{
    ...
    //
    UF_API BOOL UF_GetSecurePacketProtocolMode();
    UF_API BOOL UF_SetSecurePacketProtocolMode(BOOL securePacketProtocolMode, BYTE *secureKey);
    UF_API void UF_SetSecureCode(BYTE *secureCode);
    UF_API UF_RET_CODE UF_CreateRandomSecureKey();
    UF_API UF_RET_CODE UF_CreateKeyPair(BYTE *publicKey_host, BYTE *privateKey_host);
    UF_API void UF_GetSecureKey(BYTE *secureKey, BYTE *publicKey_module, BYTE *privateKey_host);
    UF_API UF_RET_CODE UF_PublicKeyExchange(BYTE *publicKey_host, BYTE *publicKey_module);

    //
    // Key Management
    //
    UF_API UF_RET_CODE UF_ChangeKey(UF_KEY_OPTION option, BYTE *currentKey, BYTE *newKey, BOOL verification);
