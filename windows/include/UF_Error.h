...
typedef enum
{
	...
	UF_ERR_INVALID_DATABASE_FORMAT = -403,

	UF_ERR_SECURE_CODE_VERIFICATION_FAIL = -501,
	UF_ERR_UNKNOWN = -9999,
} UF_RET_CODE;

typedef enum
{
	UF_PROTO_RET_COMMAND_FAILED = 0x60,
	...
	UF_PROTO_RET_INVALID_DATABASE_FORMAT = 0xB2,
